...
st.markdown("""
    <style>                   
        ...
        .section { background: linear-gradient(to right, #ffcccb, #ffcbbb); padding: 20px; border-radius: 15px; box-shadow: 5px 5px 15px rgba(0, 0, 0, 0.3); margin-bottom: 20px; }
...
st.markdown("""
    <div class='footer'>
        ...
        <br>
        <b>Created by <span style='color: #FF5733;'>Yashfa Anwer</span></b>
    </div>
""", unsafe_allow_html=True)
